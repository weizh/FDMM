...
import edu.cmu.lti.weizh.train.AbstractTigramFDMMTrain;

public class ON_TrigramFDMMTrain extends AbstractTigramFDMMTrain<String, ON_TrigramFDMMTrain, OntonotesDataSet> {
	...
	ON_TrigramFDMMTrain(String[] thetaHeaders, String thetaHeaderDelimiter, String thetaValueDelimiter, String[] featureHeaders,
...
//				FCONST.T_PREFIX + thd + FCONST.T_SUFFIX,
		...
		ON_TrigramFDMMTrain abctrainer = new ON_TrigramFDMMTrain(thetaHeaders, thd, tvd, featureHeaders, fhd, fvd);
...
//
		abctrainer.train(DataFactory.getONFDataSet(DATA_PATHS.ONF_ABC_TRAIN,false));
...
//
		abctrainer.store("trainedModels/ONF_ABC_TrigramFDMM_basic-fine.trainer");
...
//		voatrainer.store("trainedModels/ONF_VOA_PERC_"+voatrainer.getIterationsUsed()+"advanced.trainer");
	...
	@Override
	protected ON_TrigramFDMMTrain self() {
		return this;
	}
