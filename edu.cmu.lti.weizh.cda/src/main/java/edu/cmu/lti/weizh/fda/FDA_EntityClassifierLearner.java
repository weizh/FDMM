...
public class FDA_EntityClassifierLearner {
	...
	public FDA_EntityClassifierLearner(FDA_MLModel posModel2) {
		posModel = posModel2;
	}
	...
	public static void main(String argv[]) throws Exception {
		...
		FDA_EntityClassifierLearner onlineLearner = new FDA_EntityClassifierLearner(FDA_MLModel.load("POS-rich-randomSent-fold10.0-NOV08.en.FDA_MLModel"));
