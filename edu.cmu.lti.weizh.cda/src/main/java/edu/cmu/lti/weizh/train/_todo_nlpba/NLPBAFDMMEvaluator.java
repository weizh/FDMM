package edu.cmu.lti.weizh.train._todo_nlpba;
...
public class NLPBAFDMMEvaluator extends _TODO_AbstractFDMMEval<CONLLFormatDataSet> implements Serializable {
	...
	public static void main(String arg[]) {
		CONLLFormatDataSet sampleTestData = DataFactory.getNLPBASampleTest();
		CONLLFormatDataSet evalData = DataFactory.getNLPBAEval();

		NLPBAFDMMEvaluator eval = new NLPBAFDMMEvaluator(NLPBAFDMMTrainer.load("NLPBAFDMMTrainer"));
		
		System.out.println("Sample Test results are: ------------------------");
		eval.evaluate(sampleTestData);
		
		System.out.println("Eval results are: ------------------------");
		eval.evaluate(evalData);
	}
}
