...
public class ONF_CONSTS {
	...
	public static final HashSet<String> EntityList;
	...
	public static final String P1TYPE = "[P1TYPE]", P2TYPE = "[P2TYPE]", P3TYPE = "[P3TYPE]";
	public static final String N1TYPE = "[N1TYPE]", N2TYPE = "[N2TYPE]", N3TYPE = "[N3TYPE]";
	...
	public static final String P1END = "[P1END]", P2END = "[P2END]", P3END = "[P3END]", N1END = "[N1END]", N2END = "[N2END]",
			N3END = "[N3END]";

	public static final String P_CC = "CC", P_CD = "CD", P_DT = "DT", P_EX = "EX", P_FW = "FW", P_IN = "IN", P_JJ = "JJ",
	...
	public static final String P1TOK = "[P1TOK]", P2TOK = "[P2TOK]", P3TOK = "[P3TOK]", P4TOK = "[P4TOK]", P5TOK = "[P5TOK]",
			...
			N5CAP = "[N5CAP]", CCAP = "[CCAP]", CPOS = "[CPOS]", CTOK = "[CTOK]", CTOK_STEMMED = "[CTOK_STEMMED]",ORIGIN_CTOK="[ORIGIN_CTOK]";
