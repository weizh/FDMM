...
package edu.cmu.lti.weizh.nlputils;
 ...
 * @return
 */
  public static Sentence tokenize(Sentence sentence) {
    String sSent = sentence.getPlainSentence();
    List<String> tokenized = tokenize(sSent);
    List<Word> words = new ArrayList<Word>();
    Word t;
    for (int i = 0; i < tokenized.size(); i++) {
      words.add(new Word(tokenized.get(i)));
    }
