...
public class C2K_FDMM_Train extends AbstractFDMMTrainer<String, C2K_FDMM_Train, CONLLFormatDataSet> {
	...
	C2K_FDMM_Train(String[] thetaHeaders, String thetaHeaderDelimiter, String thetaValueDelimiter, String[] featureHeaders,
	...
	public static void main(String argb[]) {
		...
		C2K_FDMM_Train trainer = new C2K_FDMM_Train(thetaHeaders, thd, tvd, featureHeaders, fhd, fvd);
